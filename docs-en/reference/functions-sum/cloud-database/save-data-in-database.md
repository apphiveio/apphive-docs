...
The save database data is a function in the [cloud database](./README.md) functions which allows to write registers on the database this is a set which saves new data to the specified database path, adding or replacing any existing data at that path.
