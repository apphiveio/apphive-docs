...
* **Appearance**
  * **Background color:** select the background color using the [color picker](../../../reference/estilos/color-picker.md).
  * **Text color**: select text color in the text field element using the [color picker](../../../reference/estilos/color-picker.md).
  * **Placeholder color:** select text input color using the [color picker](../../../reference/estilos/color-picker.md) that will be modified before text input has been entered.
* **Dimensions**
...
* **Generic properties**
  ...
  * **Enable** [**skeleton loaders**](../../../reference/estilos/skeleton-loader.md)**:** this tool provides an indication to the user that something is coming but not yet available on the text field element.
