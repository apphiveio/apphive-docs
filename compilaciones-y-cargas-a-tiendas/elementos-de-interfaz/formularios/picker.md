...
### ​🎨 Styles <a href="#styles" id="styles"></a>

* **Appearance**
  * **Background color:** select the background color using the [color picker](../../../reference/estilos/color-picker.md).
  * **Text color**: select text color in the picker element using the [color picker](../../../reference/estilos/color-picker.md).
* **Dimensions**
...
* **Generic properties**
  ...
  * **Enable** [**skeleton loaders**](../../../reference/estilos/skeleton-loader.md)**:** this tool provides an indication to the user that something is coming but not yet available on the picker element.
