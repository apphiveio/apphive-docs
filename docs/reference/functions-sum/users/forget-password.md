...
The forget password is a function in the [users](./README.md) functions which allows to the users change their password by sending a email to the user email, this function is important to the users to secure their account.
