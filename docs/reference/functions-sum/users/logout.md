...
The logout is a function in the [users](./README.md) functions which allows to get out from the app to exit his identification and authentication. The user usually use this function to avoid the push notifications or change accounts.
