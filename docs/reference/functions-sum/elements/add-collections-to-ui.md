...
The add collection to UI is a function in the [elements](./README.md) functions which allows to create lists of elements and modify using the registers on the [database data.](../../database/README.md) 
