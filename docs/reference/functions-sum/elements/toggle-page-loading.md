...
The Toggle page loading is a function in the [elements](./README.md) functions which allows to add a page loading to show the user that the app is processing data.
