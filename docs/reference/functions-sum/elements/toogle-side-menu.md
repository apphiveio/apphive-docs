...
The toggle side menu is a function in the [elements](./README.md) functions which allows to the user open a side menu to get an access to a quick launch menu.
