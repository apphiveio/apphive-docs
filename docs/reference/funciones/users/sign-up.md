...
The Sign up is a function in the [users](./README.md) functions which allows to the users access to the app by register his data. The users typically fill forms with a "username", "password", "phone number" and "email".
