...
The get all users is a function in the [users](./README.md) functions which allows to create a list of the register users or get information from users, this function is very useful if the admin need to check or change a status of the actual users of the app.
