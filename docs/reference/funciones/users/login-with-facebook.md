...
The login with Facebook is a function in the [users](./README.md) functions which allows to the users login by identifying and authenticating themselves with a Facebook account.
