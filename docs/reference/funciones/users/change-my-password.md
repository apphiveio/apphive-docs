...
The change my password is a function in the [users](./README.md) functions which allows to the users change their password, this function is important to the users to secure their account.
