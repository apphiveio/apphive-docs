...
* **Appearance**
  ...
  * **Text color**: select text color in the chart element using the [color picker](../../../reference/estilos/color-picker.md).
  * **Color lines**: select line color in the chart element using the [color picker](../../../reference/estilos/color-picker.md).
...
![Line chart](<../../../gitbook/assets/captura-de-pantalla-2020-02-12-a-la-s-17.59.05 (1).png>)
