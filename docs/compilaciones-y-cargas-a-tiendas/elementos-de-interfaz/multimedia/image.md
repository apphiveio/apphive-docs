...
* **Generic properties**
  ...
  * **Enable** [**skeleton loaders**](../../../reference/estilos/skeleton-loader.md)**:** this tool provides an indication to the user that something is coming but not yet available on the image element.
