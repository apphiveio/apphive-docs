...
* **Appearance**
  ...
  * **Text color**: select text color using the [color picker](../../../reference/estilos/color-picker.md).
* **Dimensions**
...
* **Generic properties**
  ...
  * **Enable** [**skeleton loaders**](../../../reference/estilos/skeleton-loader.md)**:** this tool provides an indication to the user that something is coming but not yet available on the text element.
